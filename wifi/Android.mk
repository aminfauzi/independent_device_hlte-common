...
###
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-hlte_service-lib
...
###
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.hlte
LOCAL_MODULE_RELATIVE_PATH := hw
LOCAL_PROPRIETARY_MODULE := true
LOCAL_CPPFLAGS := -Wall -Werror -Wextra
...
LOCAL_STATIC_LIBRARIES := \
    android.hardware.wifi@1.0-hlte_service-lib
LOCAL_INIT_RC := android.hardware.wifi@1.0-service.hlte.rc
